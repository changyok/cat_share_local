...
foreach corner $corner_list color $color_list {
  load_file @pwd@/@nodedir|SNM_sim@/n@node|SNM_sim@_vv0_data_${corner}.csv -name ${corner}_data0
  load_file @pwd@/@nodedir|SNM_sim@/n@node|SNM_sim@_vv1_data_${corner}.csv -name ${corner}_data1
