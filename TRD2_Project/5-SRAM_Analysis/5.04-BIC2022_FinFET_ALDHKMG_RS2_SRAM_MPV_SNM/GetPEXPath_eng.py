...
nodes = dbi.get_project(swb__cell="@cell@", swb__bbox_layer="@bbox_layer@", swb__gds="@gds@", swb__selectivehighK=@selectivehighK@, swb__xp1s="vdd", swb__flow="recess_power_rail_gate_cut_late_r7")
