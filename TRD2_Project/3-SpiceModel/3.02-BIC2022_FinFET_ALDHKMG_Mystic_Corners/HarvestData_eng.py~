...
TCAD_paths = [f"{TCAD_ROOT_path}/1.06-BIC2022_FinFET_ALDHKMG_TCAD_SRAM_Nominal",
              f"{TCAD_ROOT_path}/1.07-BIC2022_FinFET_ALDHKMG_TCAD_SRAM_Nominal_Temperature",
              f"{TCAD_ROOT_path}/1.08-BIC2022_FinFET_ALDHKMG_TCAD_SRAM_ChannelLength",
              f"{TCAD_ROOT_path}/1.09-BIC2022_FinFET_ALDHKMG_TCAD_SRAM_FinWidth"]
