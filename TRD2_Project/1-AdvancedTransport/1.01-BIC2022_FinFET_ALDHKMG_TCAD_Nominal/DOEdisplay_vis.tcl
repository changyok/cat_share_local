...
#if  @SelectiveGate@
set fname "@pwd@/../1.01-BIC2022_FinFET_SelectiveDepoHKMG_TCAD_Nominal/nominal_@Type@.dat"
#else
set fname "@pwd@/../1.01-BIC2022_FinFET_ALDHKMG_TCAD_Nominal/nominal_@Type@.dat"
#endif
#endif
