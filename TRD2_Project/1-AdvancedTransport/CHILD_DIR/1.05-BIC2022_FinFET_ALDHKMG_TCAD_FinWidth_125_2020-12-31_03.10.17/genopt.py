...
optimizer.parent["project_dir"] = "/nfs/pdx/disks/icf_sandp_gwa001/changyok/swb/SNPS_DTCO/TRD2/20201220/BIC2022/1-AdvancedTransport/1.05-BIC2022_FinFET_ALDHKMG_TCAD_FinWidth"
optimizer.parent["node_dir"] = "results/nodes/125"
optimizer.parent["node"] = 125
...
m_si_v = TOptParam("vert_semi",  0.1831, 1e-3, 2, Log10)
m_si_h = TOptParam("horiz_semi", 0.4151, 1e-3, 3, Log10)
m_ox = TOptParam("ox",   0.1017, 1e-3, 2, Log10)
WF = TOptParam("WF", 4.593, 4.593-0.05, 4.593+0.05, Linear(scale=1.0))
