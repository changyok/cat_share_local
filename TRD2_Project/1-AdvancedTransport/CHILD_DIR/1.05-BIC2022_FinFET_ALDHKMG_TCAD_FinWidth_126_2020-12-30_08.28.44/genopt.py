...
optimizer.parent["node_dir"] = "results/nodes/126"
optimizer.parent["node"] = 126
...
m_si_v = TOptParam("vert_semi",  0.1446, 1e-3, 2, Log10)
m_si_h = TOptParam("horiz_semi", 0.1675, 1e-3, 3, Log10)
m_ox = TOptParam("ox",   0.0316, 1e-3, 2, Log10)
