...
optimizer.parent["node_dir"] = "results/nodes/124"
optimizer.parent["node"] = 124
...
m_si_v = TOptParam("vert_semi",  0.0954, 1e-3, 2, Log10)
m_si_h = TOptParam("horiz_semi", 2.0411, 1e-3, 3, Log10)
m_ox = TOptParam("ox",   0.001, 1e-3, 2, Log10)
